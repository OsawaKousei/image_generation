...
pipe = StableDiffusionPipeline.from_single_file(model, torch_dtype=torch.float16).to(
    "cuda"
)
...
prompt = (
    "woman,70 years old, high resolution, realistic, portrait, japanese, grey hair, smile, "
    "traditional, beautiful skin, fat, kimono"
)
negative_prompt = (
    "EasyNegative, paintings, sketches, (worst quality:2), (low quality:2), "
    "(normal quality:2), lowres, normal quality, ((monochrome)), ((grayscale)), "
    "split view, grid view, monochrome,(wrinkle:3)"
)
